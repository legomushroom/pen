...
(function() {
  var CSVReporter, CheckstyleReporter, CoffeeScript, ErrorReport, JSLintReporter, Reporter, coffeelint, config, configfinder, data, errorReport, findCoffeeScripts, fs, getFallbackConfig, glob, lintFiles, lintSource, loadRules, optimist, options, path, paths, read, reportAndExit, scripts, stdin, thisdir,
    __slice = [].slice,
  ...
  CSVReporter = (function(_super) {
    ...
    CSVReporter.prototype.publish = function() {
      var e, errors, f, header, _ref, _results;
  ...
  JSLintReporter = (function(_super) {
    ...
    JSLintReporter.prototype.publish = function() {
      var e, errors, _i, _len, _ref, _ref1;
  ...
  CheckstyleReporter = (function(_super) {
    ...
    function CheckstyleReporter() {
      return CheckstyleReporter.__super__.constructor.apply(this, arguments);
    }

    CheckstyleReporter.prototype.publish = function() {
      var context, e, errors, level, _i, _len, _ref, _ref1;
